...
var _user$project$Utils_List$groupBy = function (toComparable) {
...
var _user$project$Types$RankingSummary = F6(
	function (a, b, c, d, e, f) {
		return {name: a, pos: b, rounds: c, topscorer: d, total: e, uuid: f};
	});
var _user$project$Types$Rankings = function (a) {
	return {rankings: a};
};
var _user$project$Types$Ranking = F7(
	function (a, b, c, d, e, f, g) {
		return {name: a, pos: b, rounds: c, topscorer: d, total: e, uuid: f, bet: g};
	});

var _user$project$Stats$createRoundStat = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1._1;
	var _p2 = _p1._0;
	switch (_p2.ctor) {
		case 'I':
			return {ctor: '_Tuple2', _0: 1, _1: _p3};
		case 'II':
			return {ctor: '_Tuple2', _0: 2, _1: _p3};
		case 'III':
			return {ctor: '_Tuple2', _0: 3, _1: (_p3 / 4) | 0};
		case 'IV':
			return {ctor: '_Tuple2', _0: 4, _1: (_p3 / 7) | 0};
		case 'V':
			return {ctor: '_Tuple2', _0: 5, _1: (_p3 / 10) | 0};
		default:
			return {ctor: '_Tuple2', _0: 6, _1: (_p3 / 13) | 0};
	}
};
var _user$project$Stats$createStat = function (rs) {
	return A2(_elm_lang$core$List$map, _user$project$Stats$createRoundStat, rs);
};
var _user$project$Stats$updateTeamsRightHistogram = F2(
	function (teamsRight, teamsRightHistogram) {
		var _p4 = A2(_elm_lang$core$Dict$get, teamsRight, teamsRightHistogram);
		if (_p4.ctor === 'Nothing') {
			return A3(_elm_lang$core$Dict$insert, teamsRight, 1, teamsRightHistogram);
		} else {
			return A3(_elm_lang$core$Dict$insert, teamsRight, _p4._0 + 1, teamsRightHistogram);
		}
	});
var _user$project$Stats$updateRoundStats = F2(
	function (_p5, stats) {
		var _p6 = _p5;
		var _p9 = _p6._0;
		var _p8 = _p6._1;
		var rStats = function () {
			var _p7 = A2(_elm_lang$core$Dict$get, _p9, stats);
			if (_p7.ctor === 'Nothing') {
				return A2(_elm_lang$core$Dict$singleton, _p8, 1);
			} else {
				return A2(_user$project$Stats$updateTeamsRightHistogram, _p8, _p7._0);
			}
		}();
		return A3(_elm_lang$core$Dict$insert, _p9, rStats, stats);
	});
var _user$project$Stats$createStats = function (rss) {
	var allResults = A2(
		_elm_lang$core$List$map,
		_user$project$Stats$createRoundStat,
		_elm_lang$core$List$concat(
			A2(
				...
				rss)));
	return A3(_elm_lang$core$List$foldl, _user$project$Stats$updateRoundStats, _elm_lang$core$Dict$empty, allResults);
};
var _user$project$Stats$viewRow = function (_p10) {
	var _p11 = _p10;
	return A2(
...
var _user$project$Stats$viewRound = F2(
	function (model, r) {
		var _p12 = A2(_elm_lang$core$Dict$get, r, model);
		if (_p12.ctor === 'Nothing') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Whoops')
					]));
		} else {
			var _p15 = _p12._0;
			var rows = A2(
				_elm_lang$core$List$map,
				_user$project$Stats$viewRow,
				A2(
					_elm_lang$core$List$sortBy,
					_elm_lang$core$Basics$fst,
					_elm_lang$core$Dict$toList(_p15)));
			var lStats = _elm_lang$core$Dict$toList(_p15);
			var vals = A2(
				_elm_lang$core$List$map,
				function (_p13) {
					return _elm_lang$core$Basics$toFloat(
			...
			var labels = A2(
				...
				lStats);
			var chart = _simonh1000$elm_charts$Chart$toHtml(
				A2(
					_simonh1000$elm_charts$Chart$title,
					'This will be the title',
					A2(_simonh1000$elm_charts$Chart$vBar, vals, labels)));
			return A2(
...
var _user$project$Stats$viewRound$ = F2(
	function (model, r) {
		var _p16 = A2(_elm_lang$core$Dict$get, r, model);
		if (_p16.ctor === 'Nothing') {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
			...
			var tableHeader = A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Aantal landen goed')
							])),
						A2(
						_elm_lang$html$Html$th,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Aantal keer')
							]))
					]));
			var rows = A2(
				_elm_lang$core$List$map,
				...
				A2(
					_elm_lang$core$List$sortBy,
					_elm_lang$core$Basics$fst,
					_elm_lang$core$Dict$toList(_p16._0)));
			return A2(
				_elm_lang$html$Html$table,
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List_ops['::'], tableHeader, rows));
		}
	});
var _user$project$Stats$view = function (model) {
	var rounds = _elm_lang$core$Native_List.range(2, 6);
	return A2(
		_elm_lang$html$Html$section,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Stats$viewRound$(model),
					rounds))
			]));
};
var _user$project$Stats$update = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Stats$NoOp = {ctor: 'NoOp'};
...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {rankings: a, currentRanking: b, stats: c, err: d, location: e, route: f};
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$ShowStats = {ctor: 'ShowStats'};
...
var _user$project$Main$Stats = {ctor: 'Stats'};
var _user$project$Main$statsMatcher = A2(_sporto$hop$Hop_Matchers$match1, _user$project$Main$Stats, '/stats');
...
var _user$project$Main$matchers = _elm_lang$core$Native_List.fromArray(
	[_user$project$Main$mainMatcher, _user$project$Main$statsMatcher, _user$project$Main$detailsMatcher]);
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p20.ctor) {
				case 'Receive':
					var _p21 = _p20._0;
					var stats = _user$project$Stats$createStats(_p21.rankings);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{rankings: _p21.rankings, stats: stats}),
				...
				case 'RankingReceived':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								currentRanking: _elm_lang$core$Maybe$Just(_p20._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'NavigateTo':
				...
				case 'UrlUpdate':
					...
					var newMsg = function () {
						...
						switch (_p22.ctor) {
							case 'MainRoute':
								return _user$project$Main$ShowMain;
							case 'Details':
								return _user$project$Main$ShowDetails(_p22._0);
							default:
								return _user$project$Main$ShowStats;
						}
					}();
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{route: _p23, location: _p20._1});
					var _v15 = newMsg,
						_v16 = newModel;
					msg = _v15;
					model = _v16;
				...
				case 'ShowMain':
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{currentRanking: _elm_lang$core$Maybe$Nothing});
				...
				case 'ShowStats':
					return _elm_lang$core$Dict$isEmpty(model.stats) ? A2(_user$project$Main$fetchRankingSummary, model, '/app/rankings') : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				default:
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			}
		}
...
var _user$project$Main$init = function (_p26) {
	...
	var newModel = {
		rankings: _elm_lang$core$Native_List.fromArray(
			[]),
		currentRanking: _elm_lang$core$Maybe$Nothing,
		stats: _elm_lang$core$Dict$empty,
...
var _user$project$Main$mkUrlFromRoute = function (route) {
	...
	switch (_p30.ctor) {
		...
		default:
			return A2(
				_sporto$hop$Hop$matcherToPath,
				_user$project$Main$statsMatcher,
				_elm_lang$core$Native_List.fromArray(
					[]));
	}
};
...
var _user$project$Main$viewOverview = function (rs) {
	...
	var rankingsByPoints = A2(
		...
		A2(
			...
			A2(
				_user$project$Utils_List$groupBy,
				function (_) {
					return _.total;
				},
				rs)));
...
var _user$project$Main$view = function (model) {
	var vw = function () {
		var _p39 = model.route;
		switch (_p39.ctor) {
			case 'MainRoute':
				return _user$project$Main$viewOverview(model.rankings);
			case 'Details':
				var _p40 = model.currentRanking;
				if (_p40.ctor === 'Nothing') {
					return _user$project$Main$viewOverview(model.rankings);
				} else {
					return _user$project$Main$viewRanking(_p40._0);
				}
			default:
				return A2(
					_elm_lang$html$Html_App$map,
					...
					_user$project$Stats$view(
						A2(_elm_lang$core$Debug$log, 'stats', model.stats)));
		}
	}();
	return A2(
		_elm_lang$html$Html$div,
