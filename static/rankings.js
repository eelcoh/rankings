...
Elm.Bets.Types.make = function (_elm) {
   "use strict";
   _elm.Bets = _elm.Bets || {};
   _elm.Bets.Types = _elm.Bets.Types || {};
   if (_elm.Bets.Types.values) return _elm.Bets.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Participant = F6(function (a,b,c,d,e,f) {    return {name: a,address: b,residence: c,phone: d,email: e,howyouknowus: f};});
   var AnswerParticipant = function (a) {    return {ctor: "AnswerParticipant",_0: a};};
   var AnswerTopscorer = F2(function (a,b) {    return {ctor: "AnswerTopscorer",_0: a,_1: b};});
   var AnswerBracket = F2(function (a,b) {    return {ctor: "AnswerBracket",_0: a,_1: b};});
   var AnswerMatchWinner = F5(function (a,b,c,d,e) {    return {ctor: "AnswerMatchWinner",_0: a,_1: b,_2: c,_3: d,_4: e};});
   var AnswerGroupBestThirds = F2(function (a,b) {    return {ctor: "AnswerGroupBestThirds",_0: a,_1: b};});
   var AnswerGroupPosition = F4(function (a,b,c,d) {    return {ctor: "AnswerGroupPosition",_0: a,_1: b,_2: c,_3: d};});
   var AnswerGroupMatch = F4(function (a,b,c,d) {    return {ctor: "AnswerGroupMatch",_0: a,_1: b,_2: c,_3: d};});
   var Free = {ctor: "Free"};
   var TopThird = {ctor: "TopThird"};
   var Third = {ctor: "Third"};
   var Second = {ctor: "Second"};
   var First = {ctor: "First"};
   var None = {ctor: "None"};
   var AwayTeam = {ctor: "AwayTeam"};
   var HomeTeam = {ctor: "HomeTeam"};
   var TBD = {ctor: "TBD"};
   var Out = {ctor: "Out"};
   var In = {ctor: "In"};
   var TeamNode = F3(function (a,b,c) {    return {ctor: "TeamNode",_0: a,_1: b,_2: c};});
   var MatchNode = F6(function (a,b,c,d,e,f) {    return {ctor: "MatchNode",_0: a,_1: b,_2: c,_3: d,_4: e,_5: f};});
   var Stadium = F2(function (a,b) {    return {stadium: a,town: b};});
   var TeamDatum = F3(function (a,b,c) {    return {team: a,players: b,group: c};});
   var VI = {ctor: "VI"};
   var V = {ctor: "V"};
   var IV = {ctor: "IV"};
   var III = {ctor: "III"};
   ...
   var B = {ctor: "B"};
   var A = {ctor: "A"};
   var Team = F2(function (a,b) {    return {teamID: a,teamName: b};});
   var Bet = F4(function (a,b,c,d) {    return {answers: a,betId: b,uuid: c,active: d};});
   return _elm.Bets.Types.values = {_op: _op
                                   ,Bet: Bet
                                   ,Participant: Participant
                                   ,Team: Team
                                   ,Stadium: Stadium
                                   ,TeamDatum: TeamDatum
                                   ,AnswerGroupMatch: AnswerGroupMatch
                                   ,AnswerGroupPosition: AnswerGroupPosition
                                   ,AnswerGroupBestThirds: AnswerGroupBestThirds
                                   ,AnswerMatchWinner: AnswerMatchWinner
                                   ,AnswerBracket: AnswerBracket
                                   ,AnswerTopscorer: AnswerTopscorer
                                   ,AnswerParticipant: AnswerParticipant
                                   ,First: First
                                   ,Second: Second
                                   ,Third: Third
                                   ,TopThird: TopThird
...
Elm.Utils.Types.make = function (_elm) {
   ...
   _elm.Utils.Types = _elm.Utils.Types || {};
   if (_elm.Utils.Types.values) return _elm.Utils.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var roundFromString = function (s) {
      var _p0 = s;
      switch (_p0)
      {case "I": return $Bets$Types.I;
         case "II": return $Bets$Types.II;
         case "III": return $Bets$Types.III;
         case "IV": return $Bets$Types.IV;
         case "VI": return $Bets$Types.V;
         default: return $Bets$Types.VI;}
   };
   return _elm.Utils.Types.values = {_op: _op,roundFromString: roundFromString};
};
Elm.Main = Elm.Main || {};
